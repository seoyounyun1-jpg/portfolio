...
│   ├── sprint-mission-01/    # missions/sprint-mission-01 대응 데이터
│   └── market_base_project01/ # projects/market_base_project01 대응 데이터
└── scripts/
...
```bash
python scripts/sync_gdrive_data.py --file-id <GOOGLE_DRIVE_FILE_ID> --target sprint-mission-01
```

```bash
python scripts/sync_gdrive_data.py --file-id <GOOGLE_DRIVE_FILE_ID> --target market_base_project01
```
